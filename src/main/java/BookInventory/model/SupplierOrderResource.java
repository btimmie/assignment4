 ...
 */
public class SupplierOrderResource extends ResourceSupport {
    ...
    private SupplierOrderResource(){
    }

    public SupplierOrderResource(Builder builder){
    ...
    public static class Builder{
        ...
        public Builder copy(SupplierOrderResource value){
        ...
        public SupplierOrderResource build(){
            return new SupplierOrderResource(this);
        }
    }
}
